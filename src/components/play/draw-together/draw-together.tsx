...
const PROMPTS = [
  ...
  "Draw what you think I look like when I'm falling asleep.",
  "Draw our future, five years from now.",
  "Draw the ugliest thing you can imagine — go all out.",
  "Draw us as superheroes, with our powers.",
  "Draw what jealousy looks like.",
  "Draw the first thing you think of when you think of forever.",
  "Draw a map of a made-up world where only we live.",
  "Draw what you think my dream date would look like.",
  "Draw us as a constellation.",
  "Draw the sound of your favorite song.",
  "Draw what 'home' means to you.",
  "Draw the two of us, but as monsters — cute ones.",
  "Draw your idea of a perfect Sunday morning together.",
  "Draw what you'd want tattooed on your body for us.",
  "Draw the most romantic thing you can picture.",
  "Draw what you think is happening in my head right now.",
  "Draw us on our wedding day, however you imagine it.",
  "Draw the wildest place you'd want to be intimate together.",
  "Draw a secret you've never told anyone — abstractly, if you need to.",
];
